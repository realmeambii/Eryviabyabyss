...
/**
 * React Hook Form ↔ accessible markup.
 *
 * The value here is the wiring, not the styling: `FormControl` sets `id`,
 * `aria-describedby` and `aria-invalid` from the field's own state, so a
 * validation error is announced by a screen reader instead of only turning
 * the border red.
 */
